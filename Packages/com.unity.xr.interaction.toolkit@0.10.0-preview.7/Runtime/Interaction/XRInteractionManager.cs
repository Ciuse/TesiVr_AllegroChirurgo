...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public class XRInteractionManager : MonoBehaviour
    {
        ...
        public virtual void SelectEnter(XRBaseInteractor interactor, XRBaseInteractable interactable)
        {
            ...
            if (interactable.gameObject.layer == LayerMask.NameToLayer("Pinza"))
            {
                if (interactor.gameObject.tag.Equals("ControllerLeft"))
                {
                    controllerUsed.layer = LayerMask.NameToLayer("ControllerLeft");
                }
            
                if (interactor.gameObject.tag.Equals("ControllerRight"))
                {
                    controllerUsed.layer = LayerMask.NameToLayer("ControllerRight");
                }
            }
